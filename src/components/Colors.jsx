...
function Colors() {
    const colors = [
        { id: 'blue', name: 'Titânio Azul', image: '/img/phone-blue.jpg', colorClass: 'bg-blue-500' },
        { id: 'silver', name: 'Titânio Natural', image: '/img/phone-silver.jpg', colorClass: 'bg-gray-300' },
        { id: 'orange', name: 'Titânio Laranja', image: '/img/phone-orange.jpg', colorClass: 'bg-orange-500' },
    ];
